...
import { AssignmentLoanModel } from '@src/shared/infrastructure/server/config/database/models/assignment/assignment-loan';
...
import { DeAssignmentModel } from '@src/shared/infrastructure/server/config/database/models/assignment/de-assignment.model';
import { DiscountNoteModel } from '@src/shared/infrastructure/server/config/database/models/assignment/discount-note.model';
